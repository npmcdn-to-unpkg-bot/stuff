...
import mcrpg.rules.core.E_ModifierType;
...
public class Modifier<T> extends Value<T> {
	...
	public final javafx.beans.property.ReadOnlyObjectProperty<mcrpg.rules.core.E_ModifierType> modifierTypeProperty() {
		return this.modifierType.getReadOnlyProperty();
	}	

	public final mcrpg.rules.core.E_ModifierType getModifierType() {
