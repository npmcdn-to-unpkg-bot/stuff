...
require("rxjs/Rx");
var BBSService = (function () {
    function BBSService(_http) {
        this._http = _http;
    }
    BBSService.prototype.ngOnInit = function () {
        this.getMessageBoards();
    };
    BBSService.prototype.getMessageBoards = function () {
        var service = this;
...
//# sourceMappingURL=bbs.service.js.map